...
function SMODS.INIT.JellyTarots17()
    sendDebugMessage("Loaded JellyTarots17~")
        ...
        m_shuij = {
            name = "Crystal",
                text = {
                    ...
                    "When being scored, there is a {C:green}#1#/#2#{} chance",
                    "No {C:chips}Chips {} and{C:mult} Multiple",
                    "And copy the first played card to your hand",
       },
       },
    }

    updateLocalizationJelly17(enhance_localization, "Enhanced")

    local enhancements = {
        m_shuij = {max = 500, order = 25, name = "shuij Card", set = "Enhanced", pos = {x=5,y=1}, effect = "shuij Card", label = "shuij Card", config = {extra=4, Xmult=2.5}},
    }

    SMODS.Sprite:new("shuij", SMODS.findModByID("shuijCard").path, "Enhancedments2.png", 71, 95, "asset_atli")
    :register()
    addEnhancementsToPools(enhancements, "shuij")
...
function updateLocalizationJelly17(localizationTable, cardType)
...
function eval_card(card, context)
	if context.cardarea == G.play and not context.repetition_only and not card.debuff and card.ability.name == 'shuij Card' then
