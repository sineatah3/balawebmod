...
function SMODS.INIT.JellyTarots15()
    sendDebugMessage("Loaded JellyTarots15~")
    local enhance_localization = {
        m_jiangj = {
            name = "Bonus Medal",
                text = {
                    "{C:inactive}Hide Enhancement Cards",
                    "{C:mult}+#1#{} Multiple",
       },
       },
    }

    updateLocalizationJelly15(enhance_localization, "Enhanced")

    local enhancements = {
        m_jiangj = {max = 500, order = 23, name = "jiangj Card", set = "Enhanced", pos = {x=2,y=1}, effect = "jiangj Card", label = "jiangj Card", config = {mult=6, bonus=45}},
    }

    SMODS.Sprite:new("jiangj", SMODS.findModByID("jiangjCard").path, "Enhancedments2.png", 71, 95, "asset_atli")
    :register()
    addEnhancementsToPools(enhancements, "jiangj")
...
function updateLocalizationJelly15(localizationTable, cardType)
