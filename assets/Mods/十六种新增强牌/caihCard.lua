...
function SMODS.INIT.JellyTarots13()
    sendDebugMessage("Loaded JellyTarots13~")
    ...
    updateLocalizationJelly13(enhance_localization, "Enhanced")

    local enhancements = {
        m_caih = {max = 500, order = 21, name = "caih Card", set = "Enhanced", pos = {x=1,y=0}, effect = "caih Card", label = "caih Card", config = {Xmult=3}},
    }

    SMODS.Sprite:new("caih", SMODS.findModByID("caihCard").path, "SpriteCards.png", 71, 95, "asset_atli")
    :register()
    addEnhancementsToPools(enhancements, "caih")
...
function updateLocalizationJelly13(localizationTable, cardType)
